            ...
            <div className="flex-1 overflow-y-auto px-2 py-4 no-scrollbar">
              ...
              {isAuthenticated ? (
                ...
                <div className="p-4 text-center text-white/40">
                  <p className="text-sm">请先登录以查看对话历史</p>
                </div>
              )}
            </div>

            {/* Footer - Login/Profile (参考 ChatGPT 设计) */}
            <div className="p-4 border-t border-white/5">
              <LoginButton />
              {!isAuthenticated && (
                <button className="w-full mt-2 flex items-center gap-2 px-2 py-2 rounded-lg hover:bg-white/5 transition-colors text-white/60">
